      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <a href={doctor.doctorDetails.hospital.websiteLink} target="_blank" className="block text-blue-600 hover:underline" rel="noreferrer">
  ...
  const renderDoctorDetails = () => (
    <div className="relative z-10 text-gray-700 bg-gray-50 p-4 rounded-xl">
      ...
      <div className="mt-4">
        ...
        <img
          src={doctor.signatureImage ? `${process.env.REACT_APP_API}/${doctor.signatureImage}` : ""}
      ...
      <div className="w-1/4 bg-white p-6 h-full overflow-y-auto">
        ...
        <div className="relative p-4 bg-gradient-to-br from-[#4C49ED] to-[#020067] rounded-lg shadow-lg mb-6">
          <div className="flex items-center mb-4">
            <img
              src={doctor.profileImage ? `${process.env.REACT_APP_API}/${doctor.profileImage}` : userImage}
              alt="Doctor Profile"
