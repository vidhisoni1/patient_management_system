...
const AdminRegister = () => {
  ...
  useEffect(() => {
    const fetchHospitals = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_API}/api/hospitals`);
  ...
  const handleCreateHospital = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API}/api/hospitals`, hospitalPayload);
